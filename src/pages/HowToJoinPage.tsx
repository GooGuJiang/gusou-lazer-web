  ...
  return (
    <div className="flex flex-col gap-1 w-full max-w-md">
      ...
      >
        ...
        {/* Tooltip hint */}
        <span
          className={`absolute -top-8 right-0 text-white text-xs px-2 py-1 rounded pointer-events-none transition-opacity ${
 ...
 * Step Container
 */
const StepItem: React.FC<{ number: number; children: React.ReactNode }> = ({
  number,
  children,
}) => (
