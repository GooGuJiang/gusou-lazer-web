  ...
  return (
    <Dialog open onClose={() => undefined} className="relative z-[10000]">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-3 sm:p-6">
        <DialogPanel className="relative grid h-[calc(100dvh-1.5rem)] w-full max-w-5xl overflow-hidden rounded-3xl border border-white/15 bg-card shadow-2xl shadow-black/40 sm:h-[42rem] sm:max-h-[calc(100dvh-3rem)] md:grid-cols-[minmax(0,1fr)_minmax(16rem,38%)]">
          <div className="min-w-0 overflow-y-auto">
            <div className="flex min-h-full flex-col px-5 py-6 sm:px-8 sm:py-8 lg:px-10 lg:py-10">
              ...
              <div className="flex flex-1 flex-col justify-center">
                <DialogTitle className="text-3xl font-bold leading-tight text-text-primary sm:text-4xl">
                  {t('shutdownNotice.title')}
                </DialogTitle>

                <div className="mt-6 text-sm leading-6 text-text-secondary sm:text-base sm:leading-7">
                  <ReactMarkdown
                    components={{
