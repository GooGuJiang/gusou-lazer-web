...
const InfoCard: React.FC<InfoCardProps> = ({
  ...
  return (
    <div
      className={`bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-700 overflow-hidden transition-all duration-150 ease-in-out group hover:border-profile-color/30 hover:dark:border-profile-color/50 hover:bg-profile-color/5 hover:dark:bg-profile-color/10 h-full ${className}`}
    >
