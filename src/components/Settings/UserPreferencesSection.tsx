        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <CustomSelect
              ...
              onChange={(value) =>
                updateAndSave('beatmapset_card_size', value as BeatmapsetCardSize)
              }
              ...
              {showColorPicker && (
                <div className="absolute z-10 mt-2 p-5 bg-card rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 min-w-[320px]">
                  ...
                  <div className="relative space-y-4">
                    ...
                    {/* 彩虹渐变滑块 */}
                    <HueSlider hue={currentHue} onChange={handleHueChange} />
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                onChange={(e) =>
                  setPreferences((prev) => ({ ...prev, occupation: e.target.value }))
                }
