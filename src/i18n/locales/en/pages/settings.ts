  ...
  settings: {
    ...
    preferences: {
      ...
      beatmapset: {
        ...
        normal: 'Normal',
        large: 'Large',
        download: 'Default Beatmap Download Type',
        downloadDescription: 'Beatmap download preference',
        downloadAll: 'with video if available',
        downloadNoVideo: 'without video',
        downloadDirect: 'open in osu!direct',
        showNsfw: 'Show explicit content',
      ...
      defaultMode: {
        ...
        modes: {
          osu: 'standard',
          osurx: 'standard (Relax)',
          osuap: 'standard (Auto Pilot)',
          taiko: 'taiko',
          taikorx: 'taiko (Relax)',
          fruits: 'catch',
